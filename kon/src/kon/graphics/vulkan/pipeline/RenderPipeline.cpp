...
namespace kon
{
	RenderPipeline::RenderPipeline(Device *device, Swapchain *swapchain, CommandPool *commandPool, const RenderPipelineLayoutDef &def)
		: m_device(device), m_commandPool(commandPool), m_vertexBuffer(def.vertexBuffer), m_indexBuffer(def.indexBuffer)
	{
        ...
        vertShaderStageInfo.module = def.vertexShader->Get();
        vertShaderStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        fragShaderStageInfo.module = def.fragmentShader->Get();
		...
		VkDescriptorSetLayout pLayouts = def.descriptorLayout->Get();
		...
		for(auto &c : def.pushConstants) pushConstants.push_back(c.Get());
		pipelineLayoutInfo.pPushConstantRanges = pushConstants.data();
		pipelineLayoutInfo.pushConstantRangeCount = def.pushConstants.size();
        ...
        pipelineInfo.renderPass = def.renderPass->Get();
